<div class="container">
    ...
    <form action="{{ route('banhmi.update', $banhMi->id) }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" id="name" class="form-control" value="{{ old('name', $banhMi->name) }}"
                required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" name="price" id="price" class="form-control" value="{{ old('price', $banhMi->price) }}"
                required>
        </div>
        ...
        <div class="mb-3">
            ...
            <textarea name="description" id="description" rows="3" class="form-control">
                {{ old('description', $banhMi->description) }}
            </textarea>
        </div>
